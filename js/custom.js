(function($) {
    ...
    $('.header .box-text h1 span').typed({
        strings:["CE/CRM Specialist","Entrepreneur","Speaker","Sales Executive","World Traveler","Mechanical Engineer","Photographer","Designer","Solution Architect","Web Developer","Product Evangelist","Consultant"],
        loop: true,
        startDelay: 500,
        backDelay: 2000
    });
